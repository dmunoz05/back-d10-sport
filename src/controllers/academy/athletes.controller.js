...
export const registerAthlete = async (req, res) => {
  ...
  const db = variablesDB.academy
  const { id_coach, first_names, last_names, gender, date_birth, country, city, current_club, id_club, contact, mail, social_networks, academic_level, first_names_family, last_names_family, contact_family } = req.body
  try {
    const insert = await pool.query(`INSERT INTO ${db}.athletes_user
      (id_coach, first_names, last_names, gender, date_birth, country, city, current_club, id_club, contact, mail, social_networks, academic_level, first_names_family, last_names_family, contact_family)
      VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);`,
      [id_coach, first_names, last_names, gender, date_birth, country, city, current_club, id_club, contact, mail, social_networks, academic_level, first_names_family, last_names_family, contact_family])
